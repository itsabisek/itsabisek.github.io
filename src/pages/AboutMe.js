...
const AboutMe = () => {
    ...
    return (
        <div id="About" className="grid lg:grid-cols-4 gap-10 lg:justify-around items-center lg:p-44 p-12 bg-primaryBg text-whiteBg min-h-screen">
            ...
            <div ref={content} className={`col-span-3 grid lg:grid-rows-3 gap-8 justify-center items-center ${contentVisible ? 'animate-in fade-in-0 duration-1000' : 'opacity-0'}`}>
